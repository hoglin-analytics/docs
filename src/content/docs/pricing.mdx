...
| **Events per Month** | 1,000/day | 2,000,000 | 10,000,000 | Unlimited |
| **Data Retention** | 1 day | 30 days | 90 days | 365 days |
...
- **1,000 events per day** - Great for small communities
- **1-day retention** - See recent activity
...
- **1 day**: Perfect for real-time monitoring
...
**Network Plan and Above**: Add team members in your server settings under the "Users" section, read [Create a server](guides/create-server#invite-team-members-optional) for more info.
